...
export const SimpleInvoiceFindFirstOrThrowSelectSchema: z.ZodType<Prisma.SimpleInvoiceSelect> = z.object({
...
export const SimpleInvoiceFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    invType: z.boolean().optional(),
    invDate: z.boolean().optional(),
    billToId: z.boolean().optional(),
...
export const SimpleInvoiceFindFirstOrThrowSchema: z.ZodType<Prisma.SimpleInvoiceFindFirstOrThrowArgs> = z.object({ select: SimpleInvoiceFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SimpleInvoiceIncludeObjectSchema.optional()), orderBy: z.union([SimpleInvoiceOrderByWithRelationInputObjectSchema, SimpleInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: SimpleInvoiceWhereInputObjectSchema.optional(), cursor: SimpleInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SimpleInvoiceScalarFieldEnumSchema, SimpleInvoiceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SimpleInvoiceFindFirstOrThrowArgs>;

export const SimpleInvoiceFindFirstOrThrowZodSchema = z.object({ select: SimpleInvoiceFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => SimpleInvoiceIncludeObjectSchema.optional()), orderBy: z.union([SimpleInvoiceOrderByWithRelationInputObjectSchema, SimpleInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: SimpleInvoiceWhereInputObjectSchema.optional(), cursor: SimpleInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SimpleInvoiceScalarFieldEnumSchema, SimpleInvoiceScalarFieldEnumSchema.array()]).optional() }).strict();