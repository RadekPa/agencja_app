...
export const tblContactsFindManySelectSchema: z.ZodType<Prisma.tblContactsSelect> = z.object({
...
export const tblContactsFindManySelectZodSchema = z.object({
    ContactID: z.boolean().optional(),
    PhoneNumber: z.boolean().optional(),
    FirstName: z.boolean().optional(),
    MiddleName: z.boolean().optional(),
...
export const tblContactsFindManySchema: z.ZodType<Prisma.tblContactsFindManyArgs> = z.object({ select: tblContactsFindManySelectSchema.optional(), include: z.lazy(() => tblContactsIncludeObjectSchema.optional()), orderBy: z.union([tblContactsOrderByWithRelationInputObjectSchema, tblContactsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblContactsWhereInputObjectSchema.optional(), cursor: tblContactsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblContactsScalarFieldEnumSchema, TblContactsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblContactsFindManyArgs>;

export const tblContactsFindManyZodSchema = z.object({ select: tblContactsFindManySelectSchema.optional(), include: z.lazy(() => tblContactsIncludeObjectSchema.optional()), orderBy: z.union([tblContactsOrderByWithRelationInputObjectSchema, tblContactsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblContactsWhereInputObjectSchema.optional(), cursor: tblContactsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblContactsScalarFieldEnumSchema, TblContactsScalarFieldEnumSchema.array()]).optional() }).strict();