...
export const LocalUserFindFirstSelectSchema: z.ZodType<Prisma.LocalUserSelect> = z.object({
...
export const LocalUserFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    email: z.boolean().optional(),
    passwordHash: z.boolean().optional(),
...
export const LocalUserFindFirstSchema: z.ZodType<Prisma.LocalUserFindFirstArgs> = z.object({ select: LocalUserFindFirstSelectSchema.optional(),  orderBy: z.union([LocalUserOrderByWithRelationInputObjectSchema, LocalUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: LocalUserWhereInputObjectSchema.optional(), cursor: LocalUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LocalUserScalarFieldEnumSchema, LocalUserScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LocalUserFindFirstArgs>;

export const LocalUserFindFirstZodSchema = z.object({ select: LocalUserFindFirstSelectSchema.optional(),  orderBy: z.union([LocalUserOrderByWithRelationInputObjectSchema, LocalUserOrderByWithRelationInputObjectSchema.array()]).optional(), where: LocalUserWhereInputObjectSchema.optional(), cursor: LocalUserWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LocalUserScalarFieldEnumSchema, LocalUserScalarFieldEnumSchema.array()]).optional() }).strict();