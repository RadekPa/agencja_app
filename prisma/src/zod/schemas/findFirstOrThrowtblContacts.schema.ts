...
export const tblContactsFindFirstOrThrowSelectSchema: z.ZodType<Prisma.tblContactsSelect> = z.object({
...
export const tblContactsFindFirstOrThrowSelectZodSchema = z.object({
    ContactID: z.boolean().optional(),
    PhoneNumber: z.boolean().optional(),
    FirstName: z.boolean().optional(),
    MiddleName: z.boolean().optional(),
...
export const tblContactsFindFirstOrThrowSchema: z.ZodType<Prisma.tblContactsFindFirstOrThrowArgs> = z.object({ select: tblContactsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblContactsIncludeObjectSchema.optional()), orderBy: z.union([tblContactsOrderByWithRelationInputObjectSchema, tblContactsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblContactsWhereInputObjectSchema.optional(), cursor: tblContactsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblContactsScalarFieldEnumSchema, TblContactsScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.tblContactsFindFirstOrThrowArgs>;

export const tblContactsFindFirstOrThrowZodSchema = z.object({ select: tblContactsFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => tblContactsIncludeObjectSchema.optional()), orderBy: z.union([tblContactsOrderByWithRelationInputObjectSchema, tblContactsOrderByWithRelationInputObjectSchema.array()]).optional(), where: tblContactsWhereInputObjectSchema.optional(), cursor: tblContactsWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TblContactsScalarFieldEnumSchema, TblContactsScalarFieldEnumSchema.array()]).optional() }).strict();