...
export const SimpleInvoiceFindManySelectSchema: z.ZodType<Prisma.SimpleInvoiceSelect> = z.object({
...
export const SimpleInvoiceFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    invType: z.boolean().optional(),
    invDate: z.boolean().optional(),
    billToId: z.boolean().optional(),
...
export const SimpleInvoiceFindManySchema: z.ZodType<Prisma.SimpleInvoiceFindManyArgs> = z.object({ select: SimpleInvoiceFindManySelectSchema.optional(), include: z.lazy(() => SimpleInvoiceIncludeObjectSchema.optional()), orderBy: z.union([SimpleInvoiceOrderByWithRelationInputObjectSchema, SimpleInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: SimpleInvoiceWhereInputObjectSchema.optional(), cursor: SimpleInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SimpleInvoiceScalarFieldEnumSchema, SimpleInvoiceScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.SimpleInvoiceFindManyArgs>;

export const SimpleInvoiceFindManyZodSchema = z.object({ select: SimpleInvoiceFindManySelectSchema.optional(), include: z.lazy(() => SimpleInvoiceIncludeObjectSchema.optional()), orderBy: z.union([SimpleInvoiceOrderByWithRelationInputObjectSchema, SimpleInvoiceOrderByWithRelationInputObjectSchema.array()]).optional(), where: SimpleInvoiceWhereInputObjectSchema.optional(), cursor: SimpleInvoiceWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([SimpleInvoiceScalarFieldEnumSchema, SimpleInvoiceScalarFieldEnumSchema.array()]).optional() }).strict();