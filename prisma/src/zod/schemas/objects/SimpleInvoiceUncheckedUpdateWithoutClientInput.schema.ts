...
const makeSchema = () => z.object({
  ...
  invType: z.union([z.string(), z.lazy(() => StringFieldUpdateOperationsInputObjectSchema)]).optional(),
  ...
  sumInWords: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  balance: z.union([z.number(), z.lazy(() => NullableFloatFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  cliRef: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  descr: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  ...
  taxInfo: z.union([z.string(), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  propID: z.union([z.number().int(), z.lazy(() => NullableIntFieldUpdateOperationsInputObjectSchema)]).optional().nullable()
}).strict();
export const SimpleInvoiceUncheckedUpdateWithoutClientInputObjectSchema: z.ZodType<Prisma.SimpleInvoiceUncheckedUpdateWithoutClientInput> = makeSchema() as unknown as z.ZodType<Prisma.SimpleInvoiceUncheckedUpdateWithoutClientInput>;
export const SimpleInvoiceUncheckedUpdateWithoutClientInputObjectZodSchema = makeSchema();
