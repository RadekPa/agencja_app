...
import { ClientUpdateOneRequiredWithoutDocumentsNestedInputObjectSchema as ClientUpdateOneRequiredWithoutDocumentsNestedInputObjectSchema } from './ClientUpdateOneRequiredWithoutDocumentsNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  client: z.lazy(() => ClientUpdateOneRequiredWithoutDocumentsNestedInputObjectSchema).optional()
}).strict();
