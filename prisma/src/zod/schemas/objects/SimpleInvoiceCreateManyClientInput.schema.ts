...
export const SimpleInvoiceCreateManyClientInputObjectSchema: z.ZodType<Prisma.SimpleInvoiceCreateManyClientInput> = makeSchema() as unknown as z.ZodType<Prisma.SimpleInvoiceCreateManyClientInput>;
export const SimpleInvoiceCreateManyClientInputObjectZodSchema = makeSchema();
