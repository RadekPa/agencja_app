...
import { CustomerUpdateOneWithoutInvoicesNestedInputObjectSchema as CustomerUpdateOneWithoutInvoicesNestedInputObjectSchema } from './CustomerUpdateOneWithoutInvoicesNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  enterEmployee: z.union([z.string().max(10), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  status: z.union([z.string().max(10), z.lazy(() => NullableStringFieldUpdateOperationsInputObjectSchema)]).optional().nullable(),
  client: z.lazy(() => CustomerUpdateOneWithoutInvoicesNestedInputObjectSchema).optional()
}).strict();
