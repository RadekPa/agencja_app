...
const makeSchema = () => z.object({
  ...
  simpleInvoicesAsClient: z.lazy(() => SimpleInvoiceUncheckedCreateNestedManyWithoutClientInputObjectSchema).optional()
}).strict();
export const CustomerUncheckedCreateWithoutSimpleInvoicesAsBillToInputObjectSchema: z.ZodType<Prisma.CustomerUncheckedCreateWithoutSimpleInvoicesAsBillToInput> = makeSchema() as unknown as z.ZodType<Prisma.CustomerUncheckedCreateWithoutSimpleInvoicesAsBillToInput>;
export const CustomerUncheckedCreateWithoutSimpleInvoicesAsBillToInputObjectZodSchema = makeSchema();
