...
export const tblContactsMinOrderByAggregateInputObjectSchema: z.ZodType<Prisma.tblContactsMinOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.tblContactsMinOrderByAggregateInput>;
export const tblContactsMinOrderByAggregateInputObjectZodSchema = makeSchema();
