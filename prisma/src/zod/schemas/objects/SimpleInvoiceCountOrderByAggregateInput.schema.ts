...
export const SimpleInvoiceCountOrderByAggregateInputObjectSchema: z.ZodType<Prisma.SimpleInvoiceCountOrderByAggregateInput> = makeSchema() as unknown as z.ZodType<Prisma.SimpleInvoiceCountOrderByAggregateInput>;
export const SimpleInvoiceCountOrderByAggregateInputObjectZodSchema = makeSchema();
